...
public class Crear_dat {
    ...
    public static void main(String[] args) throws IOException {
        ...
        vehiculos carro11 = new vehiculos(1001, "Song of hell", 520, "Cuadno escuchas una cancion en las tierras de wasteland no es el camion de los helaods es solo alquien que viene a por tu vida");
        ...
        BOT bot1 = new BOT("Muerte", 0, 0, carro13, "Usando uno de los vehiculos de los jinetes de apocalipsis da caza a cualquier cosa que se mueva", "La muerte es algo con lo que te as encontrado y no has podido escapar", ".................");
        ...
        BOT bot3 = new BOT("Miku",0 , 0, carro12, "Una Cantante virtual del viejo mundo, algun idiota le hizo un cuerpo usando un cadaver y un ravager y la dejo libre por el valle", "Me diverti bastante espero que no estes enfadado conmigo :D", "Fui creada para cantar no para luchar, pero estoy feliz de probar cosas distintas");
