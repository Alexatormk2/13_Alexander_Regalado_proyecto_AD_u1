...
public class Crear_dat {
    ...
    public static void main(String[] args) throws IOException {
        ...
        vehiculos carro1 = new vehiculos(575, "Viper", 420, "Un pequeño buggy armado con 3 escopetas", "Buggy");
        vehiculos carro2 = new vehiculos(1575, "Bombarder", 420, "Un camion armado con artilleria infectado por un parasito ravager  ,seguro que quiere usarlo? ", "Camion");
        vehiculos carro3 = new vehiculos(600, "Equilibrium", 220, "Rapido y resistente poco, de quien fue la ide a de poner mecheros es como arma ?", "Deportivo");
        vehiculos carro4 = new vehiculos(400, "starter", 360, "Lo mas simple y con lo que se empieza", "Camioneta");
        vehiculos carro10 = new vehiculos(1500, "Mega-TANQUE", 420, "Un tanque de color gris que se recuerda a un lider cybertroniano cruel y tirano", "Tanque");
        vehiculos carro11 = new vehiculos(1001, "Song of hell", 420, "Cuadno escuchas una cancion en las tierras de wasteland no es el camion de los helados es solo alquien que viene a por tu vida", "Deportivo");
        vehiculos carro12 = new vehiculos(500, "Fire koopa", 480, "Rapido y letal para quemar a quienes se ponganen tu camino", "Deportivo");
        vehiculos carro13 = new vehiculos(1200, "Death_Machine", 320, "Un vehiculo que usa drones robados para luchar", "Coche funebre");
        vehiculos carro9 = new vehiculos(900, "Famine_Machine", 420, "Un vehiculo   hambriento el cual desea devorar tanto carros como survivors", "Deportivo devorador de blindaje");
        vehiculos carro8 = new vehiculos(800, "Pestilence", 500, "Un carro creado para acabar con las plagas que se encuentran por le valle, con fuego", "Carro de pestes");
        vehiculos carro7 = new vehiculos(1250, "War_Machine", 350, "Un gran vehiculo armado con una ballesta y lanzacohetes, listo para la querra", "Vehiculo de combate");
